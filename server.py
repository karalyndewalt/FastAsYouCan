...
def gen_training_plan(easy, marathon, tempo, peak_mileage):
    ...
    training_plan = [
        ...
        #                          Q2])
        ((0.60 * peak_mileage), "Easy runs @ {easy}, to meet mileage goals".format(easy=easy)),
        ((0.60 * peak_mileage), "Easy runs @ {easy}, to meet mileage goals".format(easy=easy)),
        ((0.60 * peak_mileage), "Easy runs @ {easy}, to meet mileage goals".format(easy=easy)),
        ((0.60 * peak_mileage), "Easy runs @ {easy}, to meet mileage goals".format(easy=easy),
        ...
        ((0.60 * peak_mileage), "Easy runs @ {easy}, to meet mileage goals".format(easy=easy),
            "Long run @ {easy}, distance: {distance}".format(easy=easy, distance=0.162 * peak_mileage)),
        ((0.80 * peak_mileage), "Long run @ {easy}, distance: {distance}".format(easy=easy, distance=0.216 * peak_mileage),
            "Tempo - 20 minutes @ {tempo}, broken into 2 x 10 minutes with 1 minute rest".format(tempo=tempo)),
        ((0.80 * peak_mileage), "Long run @ {easy}, distance: {distance}".format(easy=easy, distance=0.216 * peak_mileage),
            "Tempo - 20 minutes @ {tempo}, broken into 2 x 10 minutes with 1 minute rest".format(tempo=tempo)),
        ((0.70 * peak_mileage), "Two Easy runs @ {easy}, total distance: {distance}".format(easy=easy, distance=0.189 * peak_mileage),
            "Tempo - 30 minutes @ {tempo}, broken into 2 x 15 minutes with 1 minute rest".format(tempo=tempo)),
        ((0.90 * peak_mileage), "Long run @ {easy}, distance: {distance}".format(easy=easy, distance=0.243 * peak_mileage),
            "Tempo - 30 minutes @ {tempo}, broken into 3 x 10 minutes with 1 minute rest".format(tempo=tempo)),
        ((0.90 * peak_mileage), "Long run @ {easy}, distance: {distance}".format(easy=easy, distance=0.243 * peak_mileage),
            "Tempo - 30 minutes @ {tempo}, broken into 3 x 10 minutes with 1 minute rest".format(tempo=tempo)),
        ((0.70 * peak_mileage), "Marathon run for 12 miles @ {marathon}. Finish with 5 to 6 20-30 second strides with 1 minute rest.".format(marathon=marathon),
            "Tempo - 30 minutes @ {tempo}, broken into 2 x 15 minutes with 1 minute rest".format(tempo=tempo)),
        ((1.0 * peak_mileage), "Tempo - 3 x 5 minutes @ {tempo}, with 1 minute rest. Easy run @ {easy}, for 60 minutes. Tempo - 3 x 5 minutes @ {tempo}, with 1 minute rest.".format(easy=easy, tempo=tempo),
            "Tempo - 2 x 10 minutes @ {tempo}, with 2 minute rest. Easy run @ {easy}, for 75 minutes.".format(easy=easy, tempo=tempo)),
        ((0.90 * peak_mileage), "Marathon - 15 miles @ {marathon}".format(marathon=marathon),
            "Tempo - 2 x 10 minutes @ {tempo}, with 2 minute rest. Easy run @ {easy}, for 75 minutes.".format(easy=easy, tempo=tempo)),
        ((1.0 * peak_mileage), "Long run @ {easy}, distance: {distance}".format(easy=easy, distance=(0.25 * peak_mileage)),
            "Tempo - 2 x 10 minutes @ {tempo}, with 2 minute rest. Easy run @ {easy}, for 75 minutes.".format(easy=easy, tempo=tempo)),
        ((0.80 * peak_mileage), "Tempo - 3 x 5 minutes @ {tempo}, with 1 minute rest. Easy run @ {easy}, for 60 minutes. Tempo - 3 x 5 minutes @ {tempo}, with 1 minute rest.".format(easy=easy, tempo=tempo),
            "Tempo - 2 x 10 minutes @ {tempo}, with 2 minute rest. Easy run @ {easy}, for 75 minutes.".format(easy=easy, tempo=tempo)),
        ((0.80 * peak_mileage), "Marathon run for 12 miles @ {marathon} ".format(marathon=marathon),
        ...
        ((0.60 * peak_mileage), "Two Easy runs @ {easy}, total distance: {distance}".format(easy=easy, distance=0.162 * peak_mileage),
            "Easy run @ {easy}, for 2 miles. Tempo - 25 minutes @ {tempo}, broken into 5 x 5 minutes with 1 minute rest.".format(easy=easy, tempo=tempo))
    ]
